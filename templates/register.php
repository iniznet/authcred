...
>
  ...
  <div>
    <label for="email" class="relative z-0 w-full">
      <input type="email" id="email" name="email" class="block pt-4 pb-1 px-2 border-gray-200 text-sm rounded bg-transparent border appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
