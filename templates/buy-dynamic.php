...
>
  ...
  <div>
    <label for="amount" class="relative z-0 w-full">
      <input x-model="amount" type="number" id="amount" name="amount" class="block w-full pt-4 pb-1 px-2 border-gray-200 text-sm rounded bg-transparent border appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
